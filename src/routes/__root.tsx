...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Drivable, AI Driving Coach and Permit Practice" },
      ...
      { property: "og:title", content: "Drivable, AI Driving Coach for New Drivers" },
      ...
      { name: "twitter:title", content: "Drivable, AI Driving Coach for New Drivers" },
