      ...
      >
        <PopoverTrigger asChild>
          <button
            ...
            className="w-full text-left rounded-2xl border border-transparent bg-secondary hover:bg-muted transition-colors press px-4 py-3 mx-0 min-h-[56px] touch-manipulation select-none"
          >
  ...
  return (
    <>
      <div className="relative hidden md:flex shrink-0 h-full">
        <aside
          className={cn(
            "flex shrink-0 flex-col min-w-0 rounded-[32px] glass glow-soft text-sidebar-foreground h-full overflow-hidden transition-all duration-300 ease-out",
